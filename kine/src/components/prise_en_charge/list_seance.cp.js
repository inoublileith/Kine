...
const ShowPriseSeances = (props) => {
  ...
  const retrieveSeances = (id) => {
    SeanceDataService.getbyprise(id)
      .then((response) => {
...
const openTraitement = (rowIndex) => {
  const idsea = seancesRef.current[rowIndex].id
  navigate('/traitements/' + idsea)
}
    ...
    <div className='row'>
      <div className='col-sm-12'>
        <div className='element-wrapper'>
          <h6 className='element-header'>Seances</h6>
...
export default ShowPriseSeances
