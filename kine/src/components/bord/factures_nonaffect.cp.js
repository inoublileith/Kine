...
const ShowFactureAffect = (props) => {
  ...
  const openFacture = (rowIndex,x) => {
    const id = facturesRef.current[rowIndex].id
    FactureDataService.ajouter(id,x)
      .then((response) => {
        refreshList(id)
      })
      .catch((e) => {
            ...
            <div className='controls-above-table'>
              <div className='row'>
                <div className='col-sm-6'>
                  {/* <Link to={'/addBord'} className='m-3 btn btn-sm btn-primary'>
...
export default ShowFactureAffect
