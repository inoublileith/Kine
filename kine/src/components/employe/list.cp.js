...
const ShowEmployes = (props) => {
  ...
  const retrieveEmployes = () => {
    EmployeDataService.getAll(currentUser.id)
      .then((response) => {
    ...
    <div className='row'>
      <div className='col-sm-12'>
        <div className='element-wrapper'>
          <h6 className='element-header'>Employes</h6>
